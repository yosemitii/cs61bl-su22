...
public class TETile implements Serializable {
    ...
    public boolean equals(Object obj) {
        TETile toCompare = (TETile) obj;
        boolean sameCharacter = this.character == toCompare.character();
//        boolean sameTextColor = this.textColor.equals(toCompare.textColor);
//        boolean sameBackgroundColor = this.backgroundColor.equals(toCompare.textColor);
        boolean sameDescription = this.description.equals(toCompare.description);
//        boolean sameFilepath = this.filepath.equals(toCompare.filepath);
//        if (description.equals("floor")) {
//            System.out.println("----------" + description + "-----------");
//            System.out.println("sameCharacte: " + (this.character == toCompare.character()));
//            System.out.println("sameTextColor: " + (this.textColor.equals(toCompare.textColor)));
//            System.out.println("sameBackgroundColor: " + (this.backgroundColor.equals(toCompare.textColor)));
//            System.out.println("sameDescription: " + (this.description.equals(toCompare.description)));
//        }
