public class BinaryTree<T> {
    ...
    public int heightHelper(TreeNode t){
        if ((t.getLeft() == null) && (t.getRight() == null)){
            ...
            return 1 + heightHelper(t.getRight());
        }
        else if ((t.getRight() == null) && (t.getLeft() != null)){
            return 1 + heightHelper(t.getLeft());
        }
        else{
...
//        if ((N == 0) || (N == 1)){
//            return new BinaryTree<Integer>(new TreeNode<Integer>(N, null, null));
//        }
        if (N < 0) {
            return null;
        }
    ...
    public static TreeNode fibTreeHelper(int N){
        if ((N == 0) || (N == 1)){
            return new TreeNode(N, null, null);
        }
        else{
            return new TreeNode(N, fibTreeHelper(N-1), fibTreeHelper(N-2));
        }
    }
